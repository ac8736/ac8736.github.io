 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(R,j){var O=R.length;R.push(j);e:for(;0<O;){var Z=O-1>>>1,re=R[Z];if(0<o(re,j))R[Z]=j,R[O]=re,O=Z;else break e}}function n(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var j=R[0],O=R.pop();if(O!==j){R[0]=O;e:for(var Z=0,re=R.length,Lr=re>>>1;Z<Lr;){var $t=2*(Z+1)-1,Li=R[$t],Mt=$t+1,$r=R[Mt];if(0>o(Li,O))Mt<re&&0>o($r,Li)?(R[Z]=$r,R[Mt]=O,Z=Mt):(R[Z]=Li,R[$t]=O,Z=$t);else if(Mt<re&&0>o($r,O))R[Z]=$r,R[Mt]=O,Z=Mt;else break e}}return j}function o(R,j){var O=R.sortIndex-j.sortIndex;return O!==0?O:R.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],m=1,d=null,h=3,g=!1,y=!1,v=!1,k=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(R){for(var j=n(u);j!==null;){if(j.callback===null)r(u);else if(j.startTime<=R)r(u),j.sortIndex=j.expirationTime,t(s,j);else break;j=n(u)}}function w(R){if(v=!1,p(R),!y)if(n(s)!==null)y=!0,Oi(_);else{var j=n(u);j!==null&&Ii(w,j.startTime-R)}}function _(R,j){y=!1,v&&(v=!1,f(z),z=-1),g=!0;var O=h;try{for(p(j),d=n(s);d!==null&&(!(d.expirationTime>j)||R&&!Ve());){var Z=d.callback;if(typeof Z=="function"){d.callback=null,h=d.priorityLevel;var re=Z(d.expirationTime<=j);j=e.unstable_now(),typeof re=="function"?d.callback=re:d===n(s)&&r(s),p(j)}else r(s);d=n(s)}if(d!==null)var Lr=!0;else{var $t=n(u);$t!==null&&Ii(w,$t.startTime-j),Lr=!1}return Lr}finally{d=null,h=O,g=!1}}var P=!1,E=null,z=-1,K=5,L=-1;function Ve(){return!(e.unstable_now()-L<K)}function Ln(){if(E!==null){var R=e.unstable_now();L=R;var j=!0;try{j=E(!0,R)}finally{j?$n():(P=!1,E=null)}}else P=!1}var $n;if(typeof c=="function")$n=function(){c(Ln)};else if(typeof MessageChannel<"u"){var ks=new MessageChannel,Gd=ks.port2;ks.port1.onmessage=Ln,$n=function(){Gd.postMessage(null)}}else $n=function(){k(Ln,0)};function Oi(R){E=R,P||(P=!0,$n())}function Ii(R,j){z=k(function(){R(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(R){R.callback=null},e.unstable_continueExecution=function(){y||g||(y=!0,Oi(_))},e.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<R?Math.floor(1e3/R):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(R){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var O=h;h=j;try{return R()}finally{h=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(R,j){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var O=h;h=R;try{return j()}finally{h=O}},e.unstable_scheduleCallback=function(R,j,O){var Z=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?Z+O:Z):O=Z,R){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=O+re,R={id:m++,callback:j,priorityLevel:R,startTime:O,expirationTime:re,sortIndex:-1},O>Z?(R.sortIndex=O,t(u,R),n(s)===null&&R===n(u)&&(v?(f(z),z=-1):v=!0,Ii(w,O-Z))):(R.sortIndex=re,t(s,R),y||g||(y=!0,Oi(_))),R},e.unstable_shouldYield=Ve,e.unstable_wrapCallback=function(R){var j=h;return function(){var O=h;h=j;try{return R.apply(this,arguments)}finally{h=O}}}})(sc);ac.exports=sc;var vp=ac.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ws=Symbol.for("react.element"),xs=Symbol.for("react.portal"),ki=Symbol.for("react.fragment"),Ei=Symbol.for("react.strict_mode"),Ci=Symbol.for("react.profiler"),_i=Symbol.for("react.provider"),Ni=Symbol.for("react.context"),S1=Symbol.for("react.server_context"),Pi=Symbol.for("react.forward_ref"),Ti=Symbol.for("react.suspense"),Ri=Symbol.for("react.suspense_list"),zi=Symbol.for("react.memo"),ji=Symbol.for("react.lazy"),k1=Symbol.for("react.offscreen"),Wd;Wd=Symbol.for("react.module.reference");function Be(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case ws:switch(e=e.type,e){case ki:case Ci:case Ei:case Ti:case Ri:return e;default:switch(e=e&&e.$$typeof,e){case S1:case Ni:case Pi:case ji:case zi:case _i:return e;default:return t}}case xs:return t}}}A.ContextConsumer=Ni;A.ContextProvider=_i;A.Element=ws;A.ForwardRef=Pi;A.Fragment=ki;A.Lazy=ji;A.Memo=zi;A.Portal=xs;A.Profiler=Ci;A.StrictMode=Ei;A.Suspense=Ti;A.SuspenseList=Ri;A.isAsyncMode=function(){return!1};A.isConcurrentMode=function(){return!1};A.isContextConsumer=function(e){return Be(e)===Ni};A.isContextProvider=function(e){return Be(e)===_i};A.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===ws};A.isForwardRef=function(e){return Be(e)===Pi};A.isFragment=function(e){return Be(e)===ki};A.isLazy=function(e){return Be(e)===ji};A.isMemo=function(e){return Be(e)===zi};A.isPortal=function(e){return Be(e)===xs};A.isProfiler=function(e){return Be(e)===Ci};A.isStrictMode=function(e){return Be(e)===Ei};A.isSuspense=function(e){return Be(e)===Ti};A.isSuspenseList=function(e){return Be(e)===Ri};A.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===ki||e===Ci||e===Ei||e===Ti||e===Ri||e===k1||typeof e=="object"&&e!==null&&(e.$$typeof===ji||e.$$typeof===zi||e.$$typeof===_i||e.$$typeof===Ni||e.$$typeof===Pi||e.$$typeof===Wd||e.getModuleId!==void 0)};A.typeOf=Be;Vd.exports=A;var E1=Vd.exports;C`
  from,
  20%,
  53%,
  to {
...
`;function ev(e,t,n){switch(n){case"bottom-left":return t?V1:_1;case"bottom-right":return t?W1:N1;case"down":return e?t?Q1:T1:t?H1:P1;case"left":return e?t?G1:R1:t?Y1:Ss;case"right":return e?t?K1:j1:t?X1:z1;case"top-left":return t?Z1:O1;case"top-right":return t?J1:I1;case"up":return e?t?b1:$1:t?q1:L1;default:return t?B1:C1}}const wn=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=N.useMemo(()=>ev(t,r,n),[t,n,r]);return oe(Qd,{keyframes:i,...o})};C`
  from {
...
***************************************************************************** */var pa=function(){return pa=Object.assign||function(t){for(var n,r=1,o=arguments.length;r<o;r++){n=arguments[r];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},pa.apply(this,arguments)};function pv(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,r=Object.getOwnPropertySymbols(e);o<r.length;o++)t.indexOf(r[o])<0&&Object.prototype.propertyIsEnumerable.call(e,r[o])&&(n[r[o]]=e[r[o]]);return n}function mv(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document>"u")){var r=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",n==="top"&&r.firstChild?r.insertBefore(o,r.firstChild):r.appendChild(o),o.styleSheet?o.styleSheet.cssText=e:o.appendChild(document.createTextNode(e))}}var hv=`.scroll-to-top {
...
`;mv(hv);function vv(e){e===void 0&&(e=!1),e?window.scrollTo({top:0,behavior:"smooth"}):document.documentElement.scrollTop=0}var yv=function(e){var t=e.top,n=t===void 0?20:t,r=e.className,o=r===void 0?"":r,i=e.color,l=i===void 0?"black":i,a=e.smooth,s=a===void 0?!1:a,u=e.component,m=u===void 0?"":u,d=e.viewBox,h=d===void 0?"0 0 256 256":d,g=e.svgPath,y=g===void 0?"M222.138,91.475l-89.6-89.6c-2.5-2.5-6.551-2.5-9.051,0l-89.6,89.6c-2.5,2.5-2.5,6.551,0,9.051s6.744,2.5,9.244,0L122,21.85  V249.6c0,3.535,2.466,6.4,6,6.4s6-2.865,6-6.4V21.85l78.881,78.676c1.25,1.25,2.992,1.875,4.629,1.875s3.326-0.625,4.576-1.875  C224.586,98.025,224.638,93.975,222.138,91.475z":g,v=e.width,k=v===void 0?"28":v,f=e.height,c=f===void 0?"28":f,p=pv(e,["top","className","color","smooth","component","viewBox","svgPath","width","height"]),w=da.useState(!1),_=w[0],P=w[1];return da.useEffect(function(){var E=function(){P(document.documentElement.scrollTop>=n)};return E(),document.addEventListener("scroll",E),function(){return document.removeEventListener("scroll",E)}},[n]),Qn.createElement(Qn.Fragment,null,_&&Qn.createElement("button",pa({className:"scroll-to-top "+o,onClick:function(){return vv(s)},"aria-label":"Scroll to top"},p),m||Qn.createElement("svg",{width:k,height:c,fill:l,viewBox:h},Qn.createElement("path",{d:y}))))},gv=yv;const wv=Xu(gv);function xv(){return x.jsxs(x.Fragment,{children:[x.jsx(ph,{children:x.jsxs(ch,{children:[x.jsx(ia,{path:"/",element:x.jsx(rv,{})}),x.jsx(ia,{path:"/portfolio",element:x.jsx(fv,{})})]})}),x.jsx(wv,{smooth:!0})]})}fl.createRoot(document.getElementById("root")).render(x.jsx(oc.StrictMode,{children:x.jsx(xv,{})}));
