 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(j,z){var O=j.length;j.push(z);e:for(;0<O;){var Z=O-1>>>1,re=j[Z];if(0<o(re,z))j[Z]=z,j[O]=re,O=Z;else break e}}function n(j){return j.length===0?null:j[0]}function r(j){if(j.length===0)return null;var z=j[0],O=j.pop();if(O!==z){j[0]=O;e:for(var Z=0,re=j.length,Lr=re>>>1;Z<Lr;){var Mt=2*(Z+1)-1,Li=j[Mt],Ft=Mt+1,$r=j[Ft];if(0>o(Li,O))Ft<re&&0>o($r,Li)?(j[Z]=$r,j[Ft]=O,Z=Ft):(j[Z]=Li,j[Mt]=O,Z=Mt);else if(Ft<re&&0>o($r,O))j[Z]=$r,j[Ft]=O,Z=Ft;else break e}}return z}function o(j,z){var O=j.sortIndex-z.sortIndex;return O!==0?O:j.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],m=1,d=null,h=3,w=!1,g=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(j){for(var z=n(u);z!==null;){if(z.callback===null)r(u);else if(z.startTime<=j)r(u),z.sortIndex=z.expirationTime,t(s,z);else break;z=n(u)}}function x(j){if(y=!1,p(j),!g)if(n(s)!==null)g=!0,Oi(N);else{var z=n(u);z!==null&&Ii(x,z.startTime-j)}}function N(j,z){g=!1,y&&(y=!1,f(R),R=-1),w=!0;var O=h;try{for(p(z),d=n(s);d!==null&&(!(d.expirationTime>z)||j&&!Ve());){var Z=d.callback;if(typeof Z=="function"){d.callback=null,h=d.priorityLevel;var re=Z(d.expirationTime<=z);z=e.unstable_now(),typeof re=="function"?d.callback=re:d===n(s)&&r(s),p(z)}else r(s);d=n(s)}if(d!==null)var Lr=!0;else{var Mt=n(u);Mt!==null&&Ii(x,Mt.startTime-z),Lr=!1}return Lr}finally{d=null,h=O,w=!1}}var P=!1,E=null,R=-1,K=5,L=-1;function Ve(){return!(e.unstable_now()-L<K)}function Ln(){if(E!==null){var j=e.unstable_now();L=j;var z=!0;try{z=E(!0,j)}finally{z?$n():(P=!1,E=null)}}else P=!1}var $n;if(typeof c=="function")$n=function(){c(Ln)};else if(typeof MessageChannel<"u"){var ks=new MessageChannel,Gd=ks.port2;ks.port1.onmessage=Ln,$n=function(){Gd.postMessage(null)}}else $n=function(){k(Ln,0)};function Oi(j){E=j,P||(P=!0,$n())}function Ii(j,z){R=k(function(){j(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(j){j.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,Oi(N))},e.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<j?Math.floor(1e3/j):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(j){switch(h){case 1:case 2:case 3:var z=3;break;default:z=h}var O=h;h=z;try{return j()}finally{h=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(j,z){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var O=h;h=j;try{return z()}finally{h=O}},e.unstable_scheduleCallback=function(j,z,O){var Z=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?Z+O:Z):O=Z,j){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=O+re,j={id:m++,callback:z,priorityLevel:j,startTime:O,expirationTime:re,sortIndex:-1},O>Z?(j.sortIndex=O,t(u,j),n(s)===null&&j===n(u)&&(y?(f(R),R=-1):y=!0,Ii(x,O-Z))):(j.sortIndex=re,t(s,j),g||w||(g=!0,Oi(N))),j},e.unstable_shouldYield=Ve,e.unstable_wrapCallback=function(j){var z=h;return function(){var O=h;h=z;try{return j.apply(this,arguments)}finally{h=O}}}})(sc);ac.exports=sc;var vp=ac.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ws=Symbol.for("react.element"),xs=Symbol.for("react.portal"),ki=Symbol.for("react.fragment"),Ei=Symbol.for("react.strict_mode"),Ci=Symbol.for("react.profiler"),Ni=Symbol.for("react.provider"),_i=Symbol.for("react.context"),S1=Symbol.for("react.server_context"),Pi=Symbol.for("react.forward_ref"),Ti=Symbol.for("react.suspense"),ji=Symbol.for("react.suspense_list"),Ri=Symbol.for("react.memo"),zi=Symbol.for("react.lazy"),k1=Symbol.for("react.offscreen"),Wd;Wd=Symbol.for("react.module.reference");function Be(e){if(typeof e=="object"&&e!==null){var t=e.$$typeof;switch(t){case ws:switch(e=e.type,e){case ki:case Ci:case Ei:case Ti:case ji:return e;default:switch(e=e&&e.$$typeof,e){case S1:case _i:case Pi:case zi:case Ri:case Ni:return e;default:return t}}case xs:return t}}}A.ContextConsumer=_i;A.ContextProvider=Ni;A.Element=ws;A.ForwardRef=Pi;A.Fragment=ki;A.Lazy=zi;A.Memo=Ri;A.Portal=xs;A.Profiler=Ci;A.StrictMode=Ei;A.Suspense=Ti;A.SuspenseList=ji;A.isAsyncMode=function(){return!1};A.isConcurrentMode=function(){return!1};A.isContextConsumer=function(e){return Be(e)===_i};A.isContextProvider=function(e){return Be(e)===Ni};A.isElement=function(e){return typeof e=="object"&&e!==null&&e.$$typeof===ws};A.isForwardRef=function(e){return Be(e)===Pi};A.isFragment=function(e){return Be(e)===ki};A.isLazy=function(e){return Be(e)===zi};A.isMemo=function(e){return Be(e)===Ri};A.isPortal=function(e){return Be(e)===xs};A.isProfiler=function(e){return Be(e)===Ci};A.isStrictMode=function(e){return Be(e)===Ei};A.isSuspense=function(e){return Be(e)===Ti};A.isSuspenseList=function(e){return Be(e)===ji};A.isValidElementType=function(e){return typeof e=="string"||typeof e=="function"||e===ki||e===Ci||e===Ei||e===Ti||e===ji||e===k1||typeof e=="object"&&e!==null&&(e.$$typeof===zi||e.$$typeof===Ri||e.$$typeof===Ni||e.$$typeof===_i||e.$$typeof===Pi||e.$$typeof===Wd||e.getModuleId!==void 0)};A.typeOf=Be;Vd.exports=A;var E1=Vd.exports;C`
  from,
  20%,
  53%,
  to {
...
`;function M1({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=Ss,iterationCount:o=1}){return Ud`
  ...
  `}function F1(e){return e==null}function D1(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function Hd(e,t){return n=>n?e():t()}function Pr(e){return Hd(e,()=>null)}function fa(e){return Pr(()=>({opacity:0}))(e)}const Qd=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:o=1e3,fraction:i=0,keyframes:l=Ss,triggerOnce:a=!1,className:s,style:u,childClassName:m,childStyle:d,children:h,onVisibilityChange:w}=e,g=_.useMemo(()=>M1({keyframes:l,duration:o}),[o,l]);return F1(h)?null:D1(h)?oe(A1,{...e,animationStyles:g,children:String(h)}):E1.isFragment(h)?oe(Yd,{...e,animationStyles:g}):oe(c1,{children:_.Children.map(h,(y,k)=>{if(!_.isValidElement(y))return null;const f=r+(t?k*o*n:0);switch(y.type){case"ol":case"ul":return oe(ul,{children:({cx:c})=>oe(y.type,{...y.props,className:c(s,y.props.className),style:Object.assign({},u,y.props.style),children:oe(Qd,{...e,children:y.props.children})})});case"li":return oe(Gu,{threshold:i,triggerOnce:a,onChange:w,children:({inView:c,ref:p})=>oe(ul,{children:({cx:x})=>oe(y.type,{...y.props,ref:p,className:x(m,y.props.className),css:Pr(()=>g)(c),style:Object.assign({},d,y.props.style,fa(!c),{animationDelay:f+"ms"})})})});default:return oe(Gu,{threshold:i,triggerOnce:a,onChange:w,children:({inView:c,ref:p})=>oe("div",{ref:p,className:s,css:Pr(()=>g)(c),style:Object.assign({},u,fa(!c),{animationDelay:f+"ms"}),children:oe(ul,{children:({cx:x})=>oe(y.type,{...y.props,className:x(m,y.props.className),style:Object.assign({},d,y.props.style)})})})})}})})},U1={display:"inline-block",whiteSpace:"pre"},A1=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:o=0,duration:i=1e3,fraction:l=0,triggerOnce:a=!1,className:s,style:u,children:m,onVisibilityChange:d}=e,{ref:h,inView:w}=Bd({triggerOnce:a,threshold:l,onChange:d});return Hd(()=>oe("div",{ref:h,className:s,style:Object.assign({},u,U1),children:m.split("").map((g,y)=>oe("span",{css:Pr(()=>t)(w),style:{animationDelay:o+y*i*r+"ms"},children:g},y))}),()=>oe(Yd,{...e,children:m}))(n)},Yd=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:o,style:i,children:l,onVisibilityChange:a}=e,{ref:s,inView:u}=Bd({triggerOnce:r,threshold:n,onChange:a});return oe("div",{ref:s,className:o,css:Pr(()=>t)(u),style:Object.assign({},i,fa(!u)),children:l})};C`
  from,
  20%,
  40%,
  60%,
...
`;function ev(e,t,n){switch(n){case"bottom-left":return t?V1:N1;case"bottom-right":return t?W1:_1;case"down":return e?t?Q1:T1:t?H1:P1;case"left":return e?t?G1:j1:t?Y1:Ss;case"right":return e?t?K1:z1:t?X1:R1;case"top-left":return t?Z1:O1;case"top-right":return t?J1:I1;case"up":return e?t?b1:$1:t?q1:L1;default:return t?B1:C1}}const tt=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=_.useMemo(()=>ev(t,r,n),[t,n,r]);return oe(Qd,{keyframes:i,...o})};C`
  from {
...
`;function tv(){return v.jsxs("div",{className:"background-container",children:[v.jsx(tt,{triggerOnce:!0,children:v.jsxs("div",{className:"background-container-sub",children:[v.jsx("h1",{className:"fixed-margin-top",children:"Education"}),v.jsxs("div",{className:"subcontent",children:[v.jsx("h2",{children:"New York University"}),v.jsx("p",{className:"text",children:"Bachelor's of Science in Computer Science, Minor in Mathematics"}),v.jsx("p",{className:"text",children:"Attended from September 2020 to May 2024. I have taken a number of classes related to software development including: Data Structures & Algorithms, Object Oriented Programming, Computer Architecture, Operating Systems, Computer Networking, Software Engineering, Game Design, Game Engineering."})]})]})}),v.jsx(tt,{triggerOnce:!0,children:v.jsxs("div",{className:"background-container-sub",children:[v.jsx("h1",{className:"fixed-margin-top",children:"Experience"}),v.jsxs("div",{className:"subcontent",children:[v.jsxs("div",{children:[v.jsx("h2",{children:"Genesys"}),v.jsx("p",{className:"text",children:"Software Engineer Intern"}),v.jsx("p",{className:"text",children:"From May 2023 to August 2023. I designed and implemented a new feature that helps new customers easily obtain necessary resources. The feature was built with Angular and the ServerLess Framework, both using TypeScript."})]}),v.jsxs("div",{children:[v.jsx("h2",{children:"HABNET Chamber of Commerce"}),v.jsx("p",{className:"text",children:"Web Associate Intern"}),v.jsx("p",{className:"text",children:"From from July 2022 to August 2022. I assisted in the development of a new mobile app geared towards helping local merchants connect with eachother. The app was built with React Native and TypeScript."})]}),v.jsxs("div",{children:[v.jsx("h2",{children:"EGD Collective"}),v.jsx("p",{className:"text",children:"Gameplay Programmer"}),v.jsx("p",{className:"text",children:"From from October 2021 to April 2022. I worked with a team to develop a 2D fighting game in Unity, where my primary role was developing the C# scripts for the game's characters."})]})]})]})})]})}function nv(){const e=gd();return v.jsxs("header",{className:"header",children:[v.jsx("h1",{children:"Hello!"}),v.jsxs("h2",{children:["I'm ",v.jsx("span",{className:"span",children:"Andy Chen"}),", a passionate software engineer who loves developing websites and video games."]}),v.jsxs("div",{className:"button-container",children:[v.jsx("button",{className:"button",onClick:()=>e("/portfolio"),children:"Portfolio"}),v.jsx("button",{className:"button",onClick:()=>window.open("https://github.com/ac8736"),children:"GitHub"}),v.jsx("button",{className:"button",onClick:()=>window.open("https://ac8736.itch.io/"),children:"Itch.io"})]}),v.jsxs("p",{className:"contact-email",children:["If you have any inquiries, please feel free to contact me:"," ",v.jsx("a",{href:"mailto:andy.chen.swe@gmail.com",children:"andy.chen.swe@gmail.com"})]})]})}function rv(){return v.jsxs(v.Fragment,{children:[v.jsx(nv,{}),v.jsx(tv,{})]})}function ov(){const e=gd();return v.jsxs("header",{className:"header",children:[v.jsx("h1",{children:"Portfolio"}),v.jsx("h2",{children:"Welcome to my little corner of the Internet! Below are projects that I have worked on."}),v.jsx("button",{className:"button",onClick:()=>e("/"),children:"Go back"})]})}const iv="/assets/sentiment-analysis-pnfLjW0x.png",lv="/assets/hd-companion-BWMCHD3T.jpg",av="/assets/hi-tea-pM8Ww4sk.jpg";function sv(){return v.jsxs("div",{children:[v.jsx(tt,{triggerOnce:!0,children:v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Sentiment Analysis |"," ",v.jsx("a",{href:"https://sentiment-analysis-app.netlify.app/",target:"_blank",className:"anchor-link",children:"Link"})]}),v.jsx("p",{className:"text",children:"Hugging Face Transformers, PyTorch, React"}),v.jsx("p",{className:"text",children:"I used the Hugging Face Transformers API to finetune a BERT model on sentiment analysis. The dataset used was the Toxic Tweets Dataset from Kaggle. The finetuning process was achieved using PyTorch and Jupyter Notebook, and utilized Google Colab GPU resources to speed up the training process."}),v.jsx("p",{className:"text",children:"React is used to create a simple web interface for users to input text and receive a sentiment analysis prediction. Model is deployed on Hugging Face."}),v.jsx("img",{src:iv,className:"sentiment-analysis-img"})]})}),v.jsx("div",{className:"games-divider"}),v.jsx(tt,{triggerOnce:!0,children:v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Hi Tea |"," ",v.jsx("a",{href:"https://www.hiteasyracuse.com/",target:"_blank",className:"anchor-link",children:"Link"})]}),v.jsx("p",{className:"text",children:"HTML, CSS, JavaScript"}),v.jsx("p",{className:"text",children:"This website is for a local bubble tea shop in Syracuse, NY. The website is created using HTML, CSS, and JavaScript. The site is actively used by customers to view the menu and other options available with Hi Tea."}),v.jsx("img",{src:av,className:"sentiment-analysis-img"})]})}),v.jsx("div",{className:"games-divider"}),v.jsx(tt,{triggerOnce:!0,children:v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Helldivers Companion |"," ",v.jsx("a",{href:"https://main--helldivers-companion.netlify.app/",target:"_blank",className:"anchor-link",children:"Link"})]}),v.jsx("p",{className:"text",children:"SvelteKit, TypeScript"}),v.jsx("p",{className:"text",children:"Using a community API, I created a web app to display information about the game Helldivers. The app displays all the information provided, such as the sectors and each planet within them. Each planet can also open a modal, which will display its liberation status and current owner. The webapp also includes a reactive search bar to allow users to easily find planets they want to view."}),v.jsx("p",{className:"text",children:"SvelteKit with TypeScript is used to create the web app. The app is deployed on Netlify."}),v.jsx("img",{src:lv,className:"sentiment-analysis-img"})]})}),v.jsx("div",{className:"games-divider"})]})}const uv="/assets/hot_knife_game-Cw07BjE0.gif",cv="/assets/asteroids_gif-G16yT-6p.gif",fv="/assets/dungeon_fight_gif-FhoN2tDU.gif",dv="/assets/forest_gif-z2xutSYI.gif",pv="/assets/death_gif-CFNqw45b.gif";function mv(){return v.jsxs("div",{children:[v.jsx("h2",{className:"subtitle",children:"The following six games are part of a six week journey. Each week, I developed a game with emphasis on a specific characteristic. The end goal is fleshing out one of these games into a full-fledged game after the six weeks of prototyping."}),v.jsxs(tt,{triggerOnce:!0,children:[v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["1000 Degree Hot Knife | Minimalism |"," ",v.jsx("a",{href:"https://jipinyaozi.itch.io/1000-degree-hot-knife",target:"_blank",className:"anchor-link",children:"Itch.io"})]}),v.jsx("p",{className:"text",children:"Unity Game Engine, C#"}),v.jsx("p",{className:"text",children:"This game was built as a prototype with an emphasis on the theme of minimalism. Alongside two other contributors, we built a game with the goal of being simple to play and having minimalistic graphics. I was responsible for the development of the scripts (written in C#) for the game mechanics, such as the score and shields."}),v.jsx("p",{className:"text",children:"Unity Game Engine was utilized to develop this game and deployed to Itch.io. Please feel free to play and all feedback is welcome!"}),v.jsx("img",{src:uv,className:"hot-knife-gif"})]}),v.jsx("div",{className:"games-divider"})]}),v.jsxs(tt,{triggerOnce:!0,children:[v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Asteroids | Game Feel |"," ",v.jsx("a",{href:"https://ac8736.itch.io/trails",target:"_blank",className:"anchor-link",children:"Itch.io"})]}),v.jsx("p",{className:"text",children:"Unity Game Engine, C#"}),v.jsx("p",{className:"text",children:"This game was built as a prototype with an emphasis on game feel. Alongside two other contributors, we built a game with the goal of being simple to play and to have toggleable options for various different game feels, such as camera shake, particles, and sound effects. I was responsible for the development of the scripts (written in C#) for the main game mechanics, such as the shooting, asteroids spawning, and animations."}),v.jsx("p",{className:"text",children:"Unity Game Engine was utilized to develop this game and deployed to Itch.io. Please feel free to play and all feedback is welcome!"}),v.jsx("img",{src:cv,className:"asteriods-gif"})]}),v.jsx("div",{className:"games-divider"})]}),v.jsxs(tt,{triggerOnce:!0,children:[v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Dungeon Fight | Dexterity |"," ",v.jsx("a",{href:"https://ac8736.itch.io/fight",target:"_blank",className:"anchor-link",children:"Itch.io"})]}),v.jsx("p",{className:"text",children:"Unity Game Engine, C#"}),v.jsx("p",{className:"text",children:"This game was built as a prototype with an emphasis on dexterity. Alongside two other contributors, we built a game with the goal of requiring high dexterity to play, with inspiration coming from the Souls genre. I was responsible for the development of the player scripts (written in C#), such as the movement, fighting, health, and animations. This entire development process took one week, from designing to implementation."}),v.jsx("p",{className:"text",children:"Unity Game Engine was utilized to develop this game and deployed to Itch.io. Please feel free to play and all feedback is welcome!"}),v.jsx("img",{src:fv,className:"dungeon-fight-gif"})]}),v.jsx("div",{className:"games-divider"})]}),v.jsxs(tt,{triggerOnce:!0,children:[v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Forest | Level Design |"," ",v.jsx("a",{href:"https://ac8736.itch.io/forest",target:"_blank",className:"anchor-link",children:"Itch.io"})]}),v.jsx("p",{className:"text",children:"Unity Game Engine, C#"}),v.jsx("p",{className:"text",children:"This game was built as a prototype, focusing on how to design levels. With two other contributors, our goal was to produce two levels, the first to teach the basic mechanics of the game, and a second level to test the player and see how well the tutorial taught. I was responsible for developing the player actions, like the movement and the ability to pick up items. I was also involved in the designing of both levels."}),v.jsx("p",{className:"text",children:"Unity Game Engine was utilized to develop this game and deployed to Itch.io. Please feel free to play and all feedback is welcome!"}),v.jsx("img",{src:dv,className:"forest-gif"})]}),v.jsx("div",{className:"games-divider"})]}),v.jsxs(tt,{triggerOnce:!0,children:[v.jsxs("div",{className:"subcontent",children:[v.jsxs("h2",{children:["Running From Death | Procedural Generation |"," ",v.jsx("a",{href:"https://spearmintorbit.itch.io/dungeonfighter",target:"_blank",className:"anchor-link",children:"Itch.io"})]}),v.jsx("p",{className:"text",children:"Unity Game Engine, C#"}),v.jsx("p",{className:"text",children:"This game was built as a prototype, featuring procedurally generated content. Along with two other contributors, our goal was to create a game that uses procedural generation algorithms to create levels. My main responsibility was to implement procedural generation with Binary Partition and the Random Walk algorithms. I also developed the player and shooting mechanics."}),v.jsx("p",{className:"text",children:"Unity Game Engine was utilized to develop this game and deployed to Itch.io. Please feel free to play and all feedback is welcome!"}),v.jsx("img",{src:pv,className:"death-gif"})]}),v.jsx("div",{className:"games-divider"})]})]})}function hv(){const[e,t]=_.useState("websites");return v.jsxs(v.Fragment,{children:[v.jsx(ov,{}),v.jsxs("div",{className:"tab-button-group",children:[v.jsx("button",{className:e==="websites"?"tab-buttons-selected":"tab-buttons-unselected",onClick:()=>t("websites"),children:"Projects"}),v.jsx("button",{className:e==="games"?"tab-buttons-selected":"tab-buttons-unselected",onClick:()=>t("games"),children:"Games"})]}),v.jsx("div",{className:"divider"}),e==="websites"&&v.jsx(sv,{}),e==="games"&&v.jsx(mv,{})]})}function vv(e){return e&&typeof e=="object"&&"default"in e?e.default:e}var da=_,Qn=vv(da);/*! *****************************************************************************
...
***************************************************************************** */var pa=function(){return pa=Object.assign||function(t){for(var n,r=1,o=arguments.length;r<o;r++){n=arguments[r];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},pa.apply(this,arguments)};function yv(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,r=Object.getOwnPropertySymbols(e);o<r.length;o++)t.indexOf(r[o])<0&&Object.prototype.propertyIsEnumerable.call(e,r[o])&&(n[r[o]]=e[r[o]]);return n}function gv(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document>"u")){var r=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",n==="top"&&r.firstChild?r.insertBefore(o,r.firstChild):r.appendChild(o),o.styleSheet?o.styleSheet.cssText=e:o.appendChild(document.createTextNode(e))}}var wv=`.scroll-to-top {
...
`;gv(wv);function xv(e){e===void 0&&(e=!1),e?window.scrollTo({top:0,behavior:"smooth"}):document.documentElement.scrollTop=0}var Sv=function(e){var t=e.top,n=t===void 0?20:t,r=e.className,o=r===void 0?"":r,i=e.color,l=i===void 0?"black":i,a=e.smooth,s=a===void 0?!1:a,u=e.component,m=u===void 0?"":u,d=e.viewBox,h=d===void 0?"0 0 256 256":d,w=e.svgPath,g=w===void 0?"M222.138,91.475l-89.6-89.6c-2.5-2.5-6.551-2.5-9.051,0l-89.6,89.6c-2.5,2.5-2.5,6.551,0,9.051s6.744,2.5,9.244,0L122,21.85  V249.6c0,3.535,2.466,6.4,6,6.4s6-2.865,6-6.4V21.85l78.881,78.676c1.25,1.25,2.992,1.875,4.629,1.875s3.326-0.625,4.576-1.875  C224.586,98.025,224.638,93.975,222.138,91.475z":w,y=e.width,k=y===void 0?"28":y,f=e.height,c=f===void 0?"28":f,p=yv(e,["top","className","color","smooth","component","viewBox","svgPath","width","height"]),x=da.useState(!1),N=x[0],P=x[1];return da.useEffect(function(){var E=function(){P(document.documentElement.scrollTop>=n)};return E(),document.addEventListener("scroll",E),function(){return document.removeEventListener("scroll",E)}},[n]),Qn.createElement(Qn.Fragment,null,N&&Qn.createElement("button",pa({className:"scroll-to-top "+o,onClick:function(){return xv(s)},"aria-label":"Scroll to top"},p),m||Qn.createElement("svg",{width:k,height:c,fill:l,viewBox:h},Qn.createElement("path",{d:g}))))},kv=Sv;const Ev=Xu(kv);function Cv(){return v.jsxs(v.Fragment,{children:[v.jsx(ph,{children:v.jsxs(ch,{children:[v.jsx(ia,{path:"/",element:v.jsx(rv,{})}),v.jsx(ia,{path:"/portfolio",element:v.jsx(hv,{})})]})}),v.jsx(Ev,{smooth:!0})]})}fl.createRoot(document.getElementById("root")).render(v.jsx(oc.StrictMode,{children:v.jsx(Cv,{})}));
